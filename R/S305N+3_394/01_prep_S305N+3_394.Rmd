...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "01_prep_S305N+3_394.html")
  )})
---
...
data_dir <- file.path("..", "..", "data", "tau-mutant-multiome-visium", "cellranger-S2", "outs")
